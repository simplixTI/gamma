  ...
  return (
    <div className="h-screen h-[100dvh] bg-background relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-background/80 backdrop-blur-sm flex flex-col overflow-hidden">
        ...
        {/* Bottom card — compact: route info + ad (cancelar fica no header) */}
        <div className="px-4 pb-4 safe-area-bottom flex-shrink-0 space-y-2">
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1 min-w-0">
                <div className="mb-1.5">
                  <p className="text-[10px] text-muted uppercase tracking-wide">Embarque</p>
                  <p className="text-sm font-medium text-foreground truncate">{origin?.name || 'Origem'}</p>
                </div>
                <div>
                  <p className="text-[10px] text-muted uppercase tracking-wide">Destino</p>
                  <p className="text-sm font-medium text-foreground truncate">{destination?.name || 'Destino'}</p>
                </div>
              </div>
              <div className="text-right">
                <p className="text-[10px] text-muted uppercase tracking-wide">Total</p>
                <p className="text-lg font-bold text-foreground">R${price.toFixed(0)}</p>
              </div>
            </div>
          </div>
